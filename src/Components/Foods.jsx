      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div className=''>
            ...
            <div className='flex justify-between flex-wrap'>
                ...
                <button onClick={() => filterType('salad')} className='m-1 border border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Salad</button>
        ...
        <div>
            ...
            <div className='flex justify-between max-w-[390px] w-full'>
                ...
                <button onClick={() => filterPrice('4000')} className=' m-1 border border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>4000</button>
                <button onClick={() => filterPrice('2500')} className='m-1 border border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>2500</button>
                <button onClick={() => filterPrice('7000')} className='m-1 border border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>7000</button>
            </div>
        </div>
      </div>
                {/* display images */}
