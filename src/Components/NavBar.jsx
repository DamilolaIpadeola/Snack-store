...
< p className='p-2 '>PickUp</p>
      ...
      {/* cart button */}
      <button className='bg-black text-white hidden md:flex items-center py-2 border rounded-xl '>
        ...
        <nav>
            <ul className='flex flex-col p-4 text-gray-800'>
                ...
                <li className='text-xl py-4 flex'> <BsFillCartFill size={25} className="mr-4"/> Best One</li>
